...
# ============================================================
# iCloud 邮箱池（邮箱----HTML 取码地址）
# ============================================================

# 单次读取 HTML 页面的请求超时；总轮询时间仍由 OTP_MAX_WAIT 控制。
ICLOUD_REQUEST_TIMEOUT = 20

# 默认校验取码地址的 TLS 证书；仅自签名的内网服务需要关闭。
